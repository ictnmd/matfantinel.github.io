...
I really liked the previous one, but I wanted to change some things about it and use something more flexible than Jekyll. So I completely redesigned it using Figma - while retaining some design elements from before - and rewrote it with SvelteKit. [I wrote a blog post talking more about the experience](https://ducblog.bikip.pro/blog-development-sveltekit/), which also became my most-read post of all time. Nice!
